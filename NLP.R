setwd("C:/Users/Keita/OneDrive - Universitat de Barcelona/DataScienceCapstone")
...
setwd("C:/Users/Keita/OneDrive - Universitat de Barcelona/DataScienceCapstone/en_US")
...
test_token_1gram <- tokens(test_corpus, remove_numbers = TRUE, remove_punct = TRUE,
                     remove_symbols = TRUE, remove_separators = TRUE, remove_hyphens = FALSE)
rm(txtdata)
rm(merge_corpus)
rm(data_corpus)
# 
...
test_token_2gram <- tokens_ngrams(test_token, n = 2)
test_token_3gram <- tokens_ngrams(test_token, n = 3)
test_token_4gram <- tokens_ngrams(test_token, n = 4)
test_token_5gram <- tokens_ngrams(test_token, n = 5)
...
# rm(
#   list = c(test_freq_1gram, test_freq_2gram, test_freq_3gram, test_freq_4gram, test_freq_5gram)
# )
